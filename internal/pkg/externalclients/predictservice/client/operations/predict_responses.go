...
/* PredictOK describes a response with status code 200, with default header values.
...
// ContextValidate validate this predict body based on the context it is used
func (o *PredictBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *PredictBody) contextValidateSource(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(o.Source); i++ {

		if err := o.Source[i].ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("positionList" + "." + "source" + "." + strconv.Itoa(i))
			}
			return err
...
func (o *PredictBody) contextValidateTarget(ctx context.Context, formats strfmt.Registry) error {
