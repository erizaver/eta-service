...
func (m *Position) validateLat(formats strfmt.Registry) error {
	...
	if err := validate.Minimum("lat", "body", m.Lat, -90, false); err != nil {
		return err
	}

	if err := validate.Maximum("lat", "body", m.Lat, 90, false); err != nil {
		return err
	}
...
func (m *Position) validateLng(formats strfmt.Registry) error {
	...
	if err := validate.Minimum("lng", "body", m.Lng, -180, false); err != nil {
		return err
	}

	if err := validate.Maximum("lng", "body", m.Lng, 180, false); err != nil {
		return err
	}
